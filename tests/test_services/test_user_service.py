...
class TestUserService:
    ...
    async def test_create_user_success(self, service, mock_repository, user_data, mock_user):
        # Arrange
    ...
    async def test_create_user_duplicate_email(self, service, mock_repository, user_data, mock_user):
        # Arrange
